...
public static class ThrowWhen
{
    ...
    public static void Empty<T>(IEnumerable<T> argument, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
        if (!argument.Any())
            throw new ArgumentException($"Collection must not be empty.", paramName);
    }

    public static void NullOrEmpty<T>([NotNull] T? argument, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        where T : ICollection
    {
    ...
    public static void NullOrEmpty<T>([NotNull] IEnumerable<T>? argument, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
        Null(argument, paramName);
        Empty(argument, paramName);
    }
    ...
    public static void NullOrShorterThan<T>([NotNull] T? argument, int minimumLength, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        where T : ICollection
    {
        Null(argument, paramName);
    ...
    public static void NullOrShorterThan([NotNull] string? argument, int minimumLength, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
        Null(argument, paramName);
        ShorterThan(argument, minimumLength, paramName);
    }

    public static void ShorterThan(string argument, int minimumLength, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
    ...
    public static void Negative<TNumber>(TNumber argument, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    ...
    public static void NegativeOrZero<TNumber>(TNumber argument, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        where TNumber : INumber<TNumber>
    {
        if (argument <= TNumber.Zero)
