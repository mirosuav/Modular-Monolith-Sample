...
public static class PassOrThrowWhen
{
    ...
    public static T NullOrEmpty<T>([NotNull] T? argument,
    ...
    public static IEnumerable<T> NullOrEmpty<T>([NotNull] IEnumerable<T>? argument,
        [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
        ThrowWhen.NullOrEmpty(argument, paramName);
        return argument;
    ...
    public static Guid NullOrEmpty([NotNull] Guid? argument,
        [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    {
        ThrowWhen.NullOrEmpty(argument, paramName);
    ...
    public static TNumber Negative<TNumber>(TNumber argument,
        [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    ...
    public static TNumber NegativeOrZero<TNumber>(TNumber argument,
        [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        where TNumber : INumber<TNumber>
    {
